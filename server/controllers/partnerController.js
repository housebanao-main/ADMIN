...
const updatePartner = async (req, res) => {
    ...
    const { entityName, panNumber, partnerType, firmType, pocName, email, phoneNumber, gstNumber, paymentDetails, hasGst } = req.body;
    try {
        const updatedPartner = await Partner.findByIdAndUpdate(id, { entityName, panNumber, partnerType, firmType, pocName, email, phoneNumber, gstNumber, paymentDetails, hasGst }, { new: true });
        if (!updatedPartner) {
